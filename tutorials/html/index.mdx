...
You don't need previous HTML experience. If you've never written a web page before, start with **[Getting Started](./01-getting-started)** and follow the learning path in order.
:::
...
👉 **[Learn Text and Content](./hrml/text-content)**
...
| Section                          | Topic                 | Level         |
| -------------------------------- | --------------------- | ------------- |
| [01](./tutorials/html/getting-started)       | Getting Started       | Beginner      |
| [02](./tutorials/html/html-syntax)           | HTML Syntax           | Beginner      |
| [03](./tutorials/html/text-content)          | Text & Content        | Beginner      |
| [04](./tutorials/html/links-and-navigation)  | Links & Navigation    | Beginner      |
| [05](./tutorials/html/images)                | Images                | Beginner      |
...
👉 **[Start the HTML Tutorial →](./01-getting-started)**
